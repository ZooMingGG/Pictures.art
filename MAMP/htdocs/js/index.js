...
/* harmony import */ var _modules_demo_pictures__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/demo-pictures */ "./src/js/modules/demo-pictures.js");
...
/* harmony import */ var _modules_check_inputs_text__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/check-inputs-text */ "./src/js/modules/check-inputs-text.js");
/* harmony import */ var _modules_show_more_styles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/show-more-styles */ "./src/js/modules/show-more-styles.js");
/* harmony import */ var _modules_calculate_price__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/calculate-price */ "./src/js/modules/calculate-price.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_demo_pictures__WEBPACK_IMPORTED_MODULE_2__["default"])('.sizes-block');
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_3__["default"])('.accordion-heading', '.accordion-block');
  ...
  Object(_modules_check_inputs_text__WEBPACK_IMPORTED_MODULE_6__["default"])('[name="name"]');
  Object(_modules_check_inputs_text__WEBPACK_IMPORTED_MODULE_6__["default"])('[name="message"]');
  Object(_modules_show_more_styles__WEBPACK_IMPORTED_MODULE_7__["default"])('.button-styles', '.styles-2');
  Object(_modules_calculate_price__WEBPACK_IMPORTED_MODULE_8__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
});
...
var accordion = function accordion(triggerClass, contentClass) {
...
/***/ "./src/js/modules/calculate-price.js":
/*!*******************************************!*\
  !*** ./src/js/modules/calculate-price.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calculatePrice = function calculatePrice(size, material, options, promocode, result) {
...
/***/ "./src/js/modules/check-inputs-text.js":
/*!*********************************************!*\
  !*** ./src/js/modules/check-inputs-text.js ***!
  \*********************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/demo-pictures.js":
/*!*****************************************!*\
  !*** ./src/js/modules/demo-pictures.js ***!
  \*****************************************/
/*! exports provided: default */
...
var showDemoPictures = function showDemoPictures(imgSelector) {
  var blocks = document.querySelectorAll(imgSelector);

  var showDemo = function showDemo(block) {
  ...
  var hideDemo = function hideDemo(block) {
    var img = block.querySelector('img');
...
/* harmony default export */ __webpack_exports__["default"] = (showDemoPictures);
...
var forms = function forms() {
  ...
  var message = {
    ...
    success: 'Дякуємо! Скоро ми зв\'яжемося з вами',
...
var modals = function modals() {
  ...
  var bindModal = function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    window.scrollBarWidth = calcScroll();
    trigger.forEach(function (item) {
      item.addEventListener('click', function (event) {
        ...
        document.body.style.marginRight = "".concat(window.scrollBarWidth, "px");
      });
    });
  ...
  var showModalByScroll = function showModalByScroll(selector) {
...
var showMoreStyles = function showMoreStyles(triggerClass, contentClass) {
...
var sliders = function sliders(slides, direction, prev, next) {
  ...
  var autoSlide = function autoSlide(time) {
